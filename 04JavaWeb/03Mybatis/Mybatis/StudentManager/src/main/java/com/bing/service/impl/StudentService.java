...
public class StudentService implements IStudentService {
    // 创建学生数据访问层对象
    StudentMapper studentDao = MybatisUtil.getSession(true).getMapper(StudentMapper.class);
    // 创建年级数据访问层对象
    GradeMapper gradeDao = MybatisUtil.getSession(true).getMapper(GradeMapper.class);
