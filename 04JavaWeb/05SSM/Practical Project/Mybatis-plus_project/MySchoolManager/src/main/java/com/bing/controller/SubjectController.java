...
public class SubjectController {
    ...
    public ReturnData delete(@ApiParam("课程Id") @PathVariable Integer subjectId){
    ...
    public ReturnData findById(@ApiParam("课程Id") @PathVariable Integer subjectId){
    ...
    public ReturnData findByCondition(@ApiParam("年级Id") @RequestParam(required = false,defaultValue = "0") Integer gradeId,
                                      @ApiParam("课程名称") @RequestParam(required = false,defaultValue = "") String subjectName,
