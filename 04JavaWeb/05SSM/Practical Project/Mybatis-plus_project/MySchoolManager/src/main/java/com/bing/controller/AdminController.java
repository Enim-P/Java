...
public class AdminController {
    ...
    public ReturnData delete(@ApiParam("用户id") @PathVariable Integer id){
        // @ApiParam是Swagger提供的注解，用于定义参数描述
    ...
    @PostMapping("/upload")
    public ReturnData uploadOSS(@ApiParam("头像") MultipartFile photo) throws IOException {
        // 调用阿里云OSS工具类进行文件上传
    ...
    @PostMapping("/upload2")
    public ReturnData uploadLocal(@ApiParam("头像") MultipartFile photo) throws IOException {
        //获取原始文件名
