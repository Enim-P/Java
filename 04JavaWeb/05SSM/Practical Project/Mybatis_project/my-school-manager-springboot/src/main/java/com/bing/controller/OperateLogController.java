...
public class OperateLogController {
    ...
    @GetMapping
    public ReturnData findByCondition(@RequestParam(required = false,defaultValue = "0") Integer operateUser,
                                      @DateTimeFormat(pattern = "yyyy-MM-dd HH:mm:ss") LocalDateTime operateTime1,
                                      @DateTimeFormat(pattern = "yyyy-MM-dd HH:mm:ss")LocalDateTime operateTime2,
